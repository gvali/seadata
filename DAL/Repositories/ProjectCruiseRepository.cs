...
{
    public class ProjectCruiseRepository : EFRepository<ProjectCruise>, IProjectCruiseRepository
    {
        public ProjectCruiseRepository(IDbContext dbContext) : base(dbContext)
        {
        }

        public List<ProjectCruise> AllProjectCruises()
        {
            var projectcruises = DbSet.Include(b => b.ProjectCruiseId)
            .Include(b => b.ProjectId)
            .Include(b => b.CruiseId)
            .OrderBy(b => b.CruiseId).ToList();
            return projectcruises;
        }
        //public List<ProjectCruise> AllforUser(int userId)
        //{
        //    var projectpersons = DbSet.Include(b => b.ProjectCruiseId)
        //    .Include(b => b.ProjectId)
        //    .Include(b => b.CruiseId)
        //    .OrderBy(b => b.CruiseId).ToList();
        ...
        //public List<Project> GetAllForPerson(int personId)
        //{
