...
{
    public class CruisePersonRepository : EFRepository<CruisePerson>, ICruisePersonRepository
    {
        public CruisePersonRepository(IDbContext dbContext) : base(dbContext)
        {
        }

        public List<CruisePerson> AllCruisePersons()
        {
            var cruisepersons = DbSet.Include(b => b.CruisePersonId)
