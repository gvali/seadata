...
namespace DAL
{
    public class DataBaseContext : DbContext, IDbContext
    {
        ...
        public IDbSet<Cruise> Cruises { get; set; }
        public IDbSet<CruiseLeader> CruiseLeaders { get; set; }
        public IDbSet<CruisePerson> CruisePersons { get; set; }
        public IDbSet<Station> Stations { get; set; }
        public IDbSet<StationMeasurement> StationMeasurements { get; set; }
